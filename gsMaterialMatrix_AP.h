...
protected:
    ...
    T Cijkl_def (const index_t i, const index_t j, const index_t k, const index_t l) const;
    T Dijkl     (const index_t i, const index_t j, const index_t k, const index_t l) const;
    T Dijkl_def (const index_t i, const index_t j, const index_t k, const index_t l) const;

    T Nij  (const index_t i, const index_t j) const;
    T Mij  (const index_t i, const index_t j) const;
    ...
    void getMetric(index_t k) const;
    void getMetricDeformed(index_t k) const;
    void getMetricUndeformed(index_t k) const;
    void getBasis(index_t k) const;
    void getBasisDeformed(index_t k) const;
    void getBasisUndeformed(index_t k) const;
...
protected:
    ...
    mutable T           m_lambda, m_mu, m_Cconstant;

    mutable T           m_H_ori, m_H_def
