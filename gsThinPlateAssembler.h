...
*/
template <class T>
class gsThinPlateAssembler : public gsThinShellAssembler<T>
{
public:
...
/** @brief Constructor of the assembler object.
    ...
    \ingroup Assembler
*/
    gsThinPlateAssembler(const gsMultiPatch<T> & patches,
...
#include GISMO_HPP_HEADER(gsThinPlateAssembler.hpp)
#endif
