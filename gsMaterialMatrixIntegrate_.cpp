...
namespace gismo
{
  ...
  CLASS_TEMPLATE_INST gsMaterialMatrixIntegrate<real_t,MaterialOutput::PStrainN>;
  CLASS_TEMPLATE_INST gsMaterialMatrixIntegrate<real_t,MaterialOutput::PStrainM>;
